...
unique(sfhvc[is.na(sfhvc$zhvi),]$zip) %in% unique(sfhvc[is.na(sfhvc$zhvic),]$zip)
...
which(!(unique(sfhvc[is.na(sfhvc$zhvi),]$zip) %in% zipdiff3))
unique(sfhvc[is.na(sfhvc$zhvi),]$zip)[6]
...
unique(sfhvc_sub$borough)
unique(sfhvc_sub[is.na(sfhvc_sub$zhvi),]$zip)
length(unique(sfhvc_sub$zip))
...
#missing......
table(sfhvc_year$zip,sfhvc_year$year)
length(unique(sfhvc_year$zip))


sfhvc_year[sfhvc_year$zip == 10044,]
